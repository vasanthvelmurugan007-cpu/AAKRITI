        ...
        <section id="essence" className="essence-section" style={{ padding: '120px 0', background: 'transparent' }}>
            <div className="container" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(350px, 1fr))', gap: '80px', alignItems: 'center' }}>
                ...
                >
                    ...
                    <h2 className="section-title" style={{ textAlign: 'left', marginBottom: '30px', fontSize: '2.5rem' }}>
                        Empowering the<br />Unheard Voices.
                    </h2>

                    <p className="essence-text" style={{ fontSize: '1.15rem', color: 'var(--color-text-secondary)', lineHeight: '1.8' }}>
                ...
                >
                    <div style={{
                        position: 'absolute', top: '-40px', left: '-40px', fontSize: '10rem', lineHeight: 1, color: 'rgba(201, 168, 117, 0.1)', fontFamily: 'serif'
                    }}>“</div>
                    ...
                    <div style={{ marginTop: '30px', display: 'flex', gap: '15px', alignItems: 'center' }}>
                        ...
                        <div>
                            <div style={{ fontWeight: 'bold', fontSize: '1.1rem' }}>Sandeep Kumar</div>
                            <div style={{ fontSize: '0.9rem', opacity: 0.7 }}>Founder, Aakritii NGO</div>
                        </div>
                    </div>
                </motion.div>
